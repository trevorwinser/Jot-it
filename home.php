...
<script>
    ...
    function fetchNewPosts() {
        fetch('fetch-category.php?category=your_category_name') // Replace 'your_category_name' with the desired category
                ...
                posts.forEach(post => {
                    ...
                    if (post.image) {
                        ...
                        postDiv.addEventListener('click', () => {
                            window.location.href = 'postDetails.php?id=' + post.id;
                        });
